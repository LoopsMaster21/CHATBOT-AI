...
const getRelevantInfo = ai.defineTool({
  ...
  const FAQ_DATA = [
    // Accounts Management
    {
      ...
      answer: 'Start shopping for your favorite groceries today! Create an Account here or sign up with your Facebook or Google account.',
      keywords: ['create account', 'sign up', 'register'],
    },
    {
      question: 'Where do I manage my account?',
      answer: "Sign in to Spinneyslebanon.com using your credentials. Click on MY ACCOUNT at the top right of the page. Here is a list of items that you can manage under 'My Account': \"My Orders\", \"Favorites & Lists\", \"Personal Details\", \"Addresses\", \"Payment Cards\", \"Spinneys Rewards\", \"Newsletter\", \"Saved Recipes\", and \"Gift Cards\".",
      keywords: ['manage account', 'my account', 'account details', 'orders', 'favorites', 'lists', 'personal details', 'addresses', 'payment cards', 'rewards', 'newsletter', 'recipes', 'gift cards'],
    },
    {
      question: 'I forgot my password or email',
      answer: 'If you\'ve forgotten your password, visit Spinneyslebanon.com, click on "Sign in/Register", then "Reset your password?" and follow the instructions. You\'ll be sent a password reset email. If you have forgotten your email address, please contact our Online Customer Care team via the Contact Us page.',
    ...
    },
    {
      ...
      answer: "You can manage your Favorite Items & Lists by visiting 'My Account' or on the homepage in the top right corner. Remember you can mark as many items as you like as favorites and create an unlimited number of lists to ease your shopping experience!",
    ...
    },
    {
      ...
      answer: 'To change your password, sign in to Spinneyslebanon.com, go to MY ACCOUNT, under "Personal details", click Change Password, follow the instructions, and click Save.',
      keywords: ['change password', 'update password'],
    },
    {
      question: 'Deactivate or Close Account',
      answer: 'To deactivate or close your account, sign in to Spinneyslebanon.com, go to MY ACCOUNT, under "Personal details", click Deactivate/Close Account and follow the instructions.',
      keywords: ['deactivate account', 'close account', 'delete account'],
    },
    {
      question: 'What email addresses do we use?',
      answer: 'For orders, we use the email address orders@spinneyslebanon.com. For support, we use support@spinneyslebanon.com. Please disregard any emails with a different address. We will never ask for your password in an email.',
    ...
    // Grocery Orders
    {
      ...
      answer: 'Sure you can. You can choose a time slot which suits you for the delivery of your order from any of the available slots listed. You can book your delivery slot up to 30 days in advance.',
    ...
    },
    {
      ...
      answer: 'If you visit the "My Orders" page, you will find all orders placed, whether Under process, Completed, or canceled, and you will be able to re-order.',
    ...
    },
    {
      ...
      answer: 'If for any reason your order has been canceled, you will receive an email confirming the cancellation of the order and in some cases we will contact you by phone to inform you.',
    ...
    },
    {
      ...
      answer: 'Yes, it is possible. Go to \'My Account\' Page and click on \'My Orders\' and look for your previous order which you would like to place again and click Reorder. You will be able to edit your order before proceeding with the checkout process.',
      keywords: ['reorder', 'previous order', 'order again'],
    },
    {
      question: 'How do I cancel my order?',
      answer: 'You can cancel your order after it was placed only if its status is \'Order Received\'. You cannot cancel if it is \'Under Preparation\', \'Processed\', or \'Delivered\'. You can check the status on the \'My Orders\' page.',
    ...
    },
    {
      ...
      answer: 'You can reserve your slot before you start your online shopping or after you fill up your cart by clicking \'Schedule a Delivery\' at the top right corner or at checkout. However, you must checkout within 2 hours to keep the slot reserved.',
      keywords: ['choose delivery', 'delivery slot', 'reserve slot'],
    },
    {
      question: 'I\'ve got a missing Item, what do I do?',
      answer: 'We\'re sorry to hear this happened. Please contact our Online Customer Care team to report the missing item. Our contact details can be found on our Contact Us page.',
      keywords: ['missing item', 'item not in order'],
    },
    {
      question: 'How do I know when my grocery order is complete?',
      answer: 'We will email you once your order is delivered. You may also opt-in to our SMS Service to receive updates. If you are using our Mobile App, we will send you notifications on the different stages of your order. You can also check the status on the \'My Orders\' page.',
    ...
    },
    {
      ...
      answer: 'At the checkout process, we give you three options: "Call for substitution", "Equivalent substitution and no call", or "No substitution and no call".',
      keywords: ['out of stock', 'item unavailable', 'substitution'],
    },
    {
      question: 'Can I save my grocery order and come back later to finish it?',
      answer: 'The added items in your cart will not be cleared if you Log Out of your account, so you could continue shopping anytime by signing in again. Please note that if you clear your browsing data from your browser, the items in your cart will no longer be available.',
      keywords: ['save cart', 'save order', 'finish later'],
    },
    // Products & Pricing
    {
      question: 'How accurate are the descriptions of products online?',
      answer: 'We do our best to provide you with the most accurate information. However, the information is for general purposes only. It is highly recommended that customers read labels, warnings, and directions provided with the product before using or consuming it.',
    ...
    },
    {
      ...
      answer: 'Not all of our stores take part in our online delivery service. Each store has its own range. Let us know if you\'d like something added to the online shop and we\'ll put in a product request for you.',
      keywords: ['item not online', 'online availability'],
    },
    {
      question: 'How do I report a product quality issue to you?',
      answer: 'If you feel there is a problem with the quality of the product, you may report it under the product detail page under "Report An Issue". Alternatively, contact our Customer Care team via our Contact Us Page.',
      keywords: ['product quality', 'quality issue', 'report problem'],
    },
    {
      question: 'How do I find out if you have a product in stock?',
      answer: 'If the product is out of stock, it will be clearly marked on the product image, and you won\'t be able to add it to your cart. Sometimes, an item may go out of stock while we are fulfilling your order, and we will handle it based on the substitution preference you chose at checkout.',
    ...
    // Mobile App
    {
      ...
      answer: 'The Spinneys\' app lets you shop 10,000+ products, create or edit orders, shop favorites, browse curated categories, link your Loyalty card, and get all our best offers and deals.',
    ...
    },
    {
      ...
      answer: 'Please login to the app with the same details as your Spinneyslebanon.com account. Your account is shared across the website and the app.',
      keywords: ['app login', 'app account'],
    },
    {
      question: 'I don’t have a Spinneyslebanon.com account. Can I still shop on the app?',
      answer: 'You can search and browse products without an account. However, adding items to the cart, managing lists, and checking out require an account. You can sign up within the app.',
    ...
    },
    {
      ...
      answer: 'Yes, if you add an item to your cart from the mobile app, it will reflect on the website version and vice versa. In some cases, you might need to refresh the page.',
      keywords: ['sync cart', 'app and website sync'],
    },
    // Offers & Promotions
    {
      question: 'My Cashback Vouchers have expired, can I still use them?',
      answer: 'We are sorry you were not able to use your vouchers before the expiry date, but we\'re unable to replace them. The vouchers we issue carry an expiry date so we can plan our stock levels and future offers.',
    ...
    },
    {
      ...
      answer: 'Our drivers will attempt to contact you if the delivery is delayed. If your delivery hasn\'t arrived and you haven\'t heard from us, please contact our Customer Care Team.',
    ...
    },
    {
      ...
      answer: 'For online card payments, the amount is authorized when you place the order and charged when your order ships. For Gift Cards, money is deducted when you place the order. For Cash or Card on Delivery, you pay at the time of delivery.',
    ...
    },
    {
      ...
      answer: 'An authorization hold is a temporary hold on your card to confirm funds are available. You are only charged for what you receive. Your bank will remove the hold within 3-5 business days.',
    ...
    },
    {
      ...
      answer: 'Points can take up to 48 hours to show. Ensure your order status is "Order Delivered". If you still need help, please contact our Online Customer Care team.',
